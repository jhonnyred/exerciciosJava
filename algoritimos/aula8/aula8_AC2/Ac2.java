...
public class Ac2 {
    public static void main(String[] args) {
        ...
        // segunda variável [nota2, peso2]
        // funcionam como uma memória secundária onde se acumula todas as informações do
        // for. A memória secundária
        ...
        for (int i = 1; i <= quantia; i++) {
            ...
            input.nextLine();
            nota = input.nextLine();
            // tive q colocar essa linha extra para conseguir limpar o buffer e remover
            // possíveis "\n"
